...
public class AddGigWork extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jobPostModeOfPayment = findViewById(R.id.job_post_mode_of_payment);
    ...
    private void saveJobPost() {
        ...
        String modeOfPayment = jobPostModeOfPayment.getText().toString().trim();
        ...
        jobPost.put("mode_of_payment", modeOfPayment);
